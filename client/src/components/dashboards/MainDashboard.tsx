      ...
      <Grid columns={4}>
        <GridColumn>
          <Card>
            <Image
              fluid
              src="../src/assets/other/seeds.jpg"
              as={Link}
              to="/sewingplan"
            />
            <CardContent>
              <CardHeader>
                ...
                {stats && stats?.missingSowingThisWeekAmount > 0 ? (
                  <Popup
                    content="Tento týden zbývá vysadit"
                    trigger={
                      <Label as={Link} to="/sewingplan" color="red">
                        <FontAwesomeIcon icon={faSeedling} />{" "}
                        {stats?.missingSowingThisWeekAmount}
                      </Label>
                    }
                  />
                ) : null}
        ...
        <GridColumn>
          <Card>
            <Image
              fluid
              src="../src/assets/other/raised_bed.jpg"
              as={Link}
              to="/plantrecords"
            />
            <CardContent>
              <CardHeader>
                ...
                {stats?.highTemperatureAlert ? (
                  <Popup
                    content="Nebezpečí vysokých teplot"
                    trigger={
                      <Label as={Link} to="/plantrecords" color="red">
        ...
        <GridColumn>
          <Card>
            <Image
              fluid
              src="../src/assets/other/plan.jpg"
              as={Link}
              to="/beds"
            />
            <CardContent>
              <CardHeader>Plánování záhonů</CardHeader>
            </CardContent>
          </Card>
        </GridColumn>
        <GridColumn>
            ...
            <CardContent>
              <CardHeader>
                ...
                {stats && stats?.missingTaskThisWeekAmount > 0 ? (
                  <Popup
                    content="Zbývá úkolů pro tento týden"
                    trigger={
                      <Label as={Link} to="/calendar" color="red">
                        <FontAwesomeIcon icon={faSquareCheck} />{" "}
                        {stats?.missingTaskThisWeekAmount}
                      </Label>
                    }
                  />
                ) : null}
