...
const PlantRecordsListComponent = observer(function PlantRecordsList() {
    ...
    const RenderPlantRecord = (plantRecord: PlantRecordDTO, plant: PlantDTO | undefined) => {
        ...
        return (
            ...
            <Checkbox className="plant-record-checkbox" onChange={()=>deleteCheckBoxChange(plantRecord.id)}/>         
                ...
                <Card.Content extra>
                    ...
                    <Popup content='Smazat' trigger={
                        <Button icon='minus'
                            color='red'
                            onClick={() => store.modalStore.openModal(<ConfirmationDeleteComponent handleSubmit={()=>deleteRecord(plantRecord.id)} />)}
                        />}
                    />
    ...
    return (
        <Container>
            ...
            <Button icon='minus' color="red" content="Smazat oznacene" disabled={!selectedItems.length} onClick={() => store.modalStore.openModal(<ConfirmationDeleteComponent handleSubmit={deleteSelected} />)}
                        />
            <Container>
